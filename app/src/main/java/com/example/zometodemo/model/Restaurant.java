...
private final static long serialVersionUID = 8822978158989397203L;
...
public Restaurant(R r, String apikey, String id, String name, String url, Location location, Integer switchToOrderMenu, String cuisines, String timings, Integer averageCostForTwo, Integer priceRange, String currency, List<String> highlights, List<Object> offers, Integer opentableSupport, Integer isZomatoBookRes, String mezzoProvider, Integer isBookFormWebView, String bookFormWebViewUrl, String bookAgainUrl, String thumb, UserRating userRating, Integer allReviewsCount, String photosUrl, Integer photoCount, String menuUrl, String featuredImage, Boolean medioProvider, Integer hasOnlineDelivery, Integer isDeliveringNow, String storeType, Boolean includeBogoOffers, String deeplink, String orderUrl, String orderDeeplink, Integer isTableReservationSupported, Integer hasTableBooking, String eventsUrl, String phoneNumbers, AllReviews allReviews, List<String> establishment, List<Object> establishmentTypes) {
        super();
        this.r = r;
        this.apikey = apikey;
        this.id = id;
